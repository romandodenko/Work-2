...
<head>
  ...
  <title>szczesliwy-dzien.com</title>
</head>
    ...
    <header class="header">
      <div class="header__container container">
        ...
        <div class="header__menu">
          ...
          <nav class="nav">
            <ul class="nav__list nav__list_dynamic">
              <li class="nav__item">
          ...
          <a class="header__logo" href="main.php" data-da=".header__container, 991, first">
            <img src="./img/logo.svg" alt="Logo">
          </a>
          <nav class="nav nav_2">
            <ul class="nav__list">
              <li class="nav__item"  data-da=".nav__list_dynamic, 991, 2">
                <a class="nav__link" href="main.php#about">
                  O nas
                </a>
              </li>
              <li class="nav__item"  data-da=".nav__list_dynamic, 991, 3">
