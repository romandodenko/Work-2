      ...
      <div class="container">
        ...
        <ul class="gry__list">
          ...
          <li class="gry__item gry__item_2">
            <a href="game-2.php">
              <picture>
                <source srcset="./img/game-2.webp" type="image/webp"><img src="./img/game-2.jpg" alt="Game"></picture>
            </a>
          </li>
      ...
      <div class="container">
        ...
        <div class="nas__content">
          ...
          <div class="nas__descr">
            <p class="nas__text">
              Wszystkie automaty hazardowe prezentowane na naszej stronie są certyfikowane i spełniają najwyższe
              wymagania i standardy dotyczące hazardu. Do testowania na wszystkich automatach dostępna jest darmowa gra.
              Możemy również śmiało powiedzieć, że wszystkie darmowe automaty do gier mają te same funkcje i szanse na
              wygraną, co ich płatne odpowiedniki. Tutaj zebrano najlepsze automaty do gier , które są obecne w prawie
              wszystkich nowoczesnych kasynach w Internecie. Graj w nowe automaty do gier bez rejestracji i bez SMS-ów,
              a los może ci się spodobać.
            </p>
            <div class="nas__item">
              <p class="nas__text">
                Jeśli wyobrażasz sobie automaty do gier jako nic innego jak specjalne maszyny z dźwigniami i migoczącymi
                elektrycznymi światłami stojącymi w rzędach, Twoje informacje są nieaktualne. Dziś można w nie grać na
                wiele sposobów, w tym obstawiać zdalnie przez Internet.
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <ul class="korjech__list">
          ...
          <li class="korjech__item">
            ...
            <p class="korjech__text">
              Aby zagrać na naszej stronie nie musisz się rejestrować i tracić dodatkowego czasu. Wystarczy wejść na
              stronę i rozpocząć grę.
            </p>
          </li>
        </ul>
      </div>
