    ...
    <main>
      <section class="content content_2">
        <div class="content__body">
          <div class="terms">
            <div class="container">
              <h1>Privacy Policy for austral-top.com</h1>

              <p>At austral-top.com, accessible from austral-top.com, one of our main priorities is the privacy of our
                visitors. This Privacy Policy document contains types of information that is collected and recorded by
                austral-top.com and how we use it.</p>
              ...
              <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards to the information that they shared and/or collect in austral-top.com. This policy is not
              ...
              <p>austral-top.com follows a standard procedure of using log files. These files log visitors when they
                visit
              ...
              <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                are
                used in their respective advertisements and links that appear on austral-top.com, which are sent
                directly
              ...
              <p>Note that austral-top.com has no access to or control over these cookies that are used by third-party
                advertisers.</p>

              <h2>Third Party Privacy Policies</h2>

              <p>austral-top.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
              ...
              <p>austral-top.com does not knowingly collect any Personal Identifiable Information from children under
                the
