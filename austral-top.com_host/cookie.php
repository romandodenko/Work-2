    ...
    <main>
      <section class="content content_2">
        <div class="content__body">
          <div class="terms">
            <div class="container">
              <h1>Cookie Policy for austral-top.com</h1>

              <p>This is the Cookie Policy for austral-top.com, accessible from austral-top.com</p>
              ...
              <ul>
                ...
                <li>
                  ...
                  <p>From time to time we offer user surveys and questionnaires to provide you with interesting
                    insights,
                    helpful tools, or to understand our user base more accurately. These surveys may use cookies to
                    remember who has already taken part in a survey or to provide you with accurate results after you
                    change pages.</p>
                </li>
              ...
              <ul>
                ...
                <li>
                  <p>Several partners advertise on our behalf and affiliate tracking cookies simply allow us to see if
                    ...
                    appropriately and where applicable allow our affiliate partners to provide any bonus that they may
