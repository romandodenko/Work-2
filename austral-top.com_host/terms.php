        ...
        <div class="content__body">
          <div class="terms">
            <div class="container">
              ...
              <p>Welcome to austral-top.com!</p>

              <p>These terms and conditions outline the rules and regulations for the use of austral-top.com's Website,
                located at austral-top.com.</p>

              <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                austral-top.com if you do not agree to take all of the terms and conditions stated on this page.</p>
              ...
              <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer
                ...
                offer, acceptance and consideration of payment necessary to undertake the process of our assistance to
                the
                Client in the most appropriate manner for the express purpose of meeting the Client’s needs in respect
                of
              ...
              <p>We employ the use of cookies. By accessing austral-top.com, you agreed to use cookies in agreement with
                the austral-top.com's Privacy Policy. </p>
              ...
              <p>Unless otherwise stated, austral-top.com and/or its licensors own the intellectual property rights for
                all material on austral-top.com. All intellectual property rights are reserved. You may access this from
                austral-top.com for your own personal use subjected to restrictions set in these terms and conditions.
              </p>

              <p>You must not:</p>
              <ul>
                <li>Republish material from austral-top.com</li>
                <li>Sell, rent or sub-license material from austral-top.com</li>
                <li>Reproduce, duplicate or copy material from austral-top.com</li>
                <li>Redistribute content from austral-top.com</li>
              </ul>

              <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                certain areas of the website. austral-top.com does not filter, edit, publish or review Comments prior to
                their presence on the website. Comments do not reflect the views and opinions of austral-top.com,its
                agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and
                opinions. To the extent permitted by applicable laws, austral-top.com shall not be liable for the
                Comments
              ...
              <p>austral-top.com reserves the right to monitor all Comments and to remove any Comments which can be
              ...
              <p>You hereby grant austral-top.com a non-exclusive license to use, reproduce, edit and authorize others
                to
              ...
              <p>We will approve link requests from these organizations if we decide that: (a) the link would not make
                ...
                absence of austral-top.com; and (d) the link is in the context of general resource information.</p>
              ...
              <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                website, you must inform us by sending an e-mail to austral-top.com. Please include your name, your
              ...
              <p>No use of austral-top.com's logo or other artwork will be allowed for linking absent a trademark
                license
                agreement.</p>
