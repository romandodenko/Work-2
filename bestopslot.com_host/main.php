      ...
      <ul class="speles__list">
        <li class="speles__item">
          <div class="speles__image">
            <a href="game-1.php">
              <picture>
                <source srcset="./img/game-1.webp" type="image/webp"><img src="./img/game-1.jpg" alt="Image"></picture>
            </a>
          </div>
        ...
        <li class="speles__item">
          <div class="speles__image">
            <a href="game-2.php">
              <picture>
                <source srcset="./img/game-2.webp" type="image/webp"><img src="./img/game-2.jpg" alt="Image"></picture>
            </a>
          </div>
          <div class="speles__descr">
    ...
    <div class="container">
      ...
      <ul class="spelu__list">
        <li class="spelu__item spelu__item_1">
          <picture>
            <source srcset="./img/image.webp" type="image/webp"><img src="./img/image.png" alt="Image"></picture>
        </li>
        <li class="spelu__item spelu__item_2">
          <picture>
            <source srcset="./img/image-2.webp" type="image/webp"><img src="./img/image-2.png" alt="Image"></picture>
        </li>
        <li class="spelu__item spelu__item_3">
          <picture>
            <source srcset="./img/image-3.webp" type="image/webp"><img src="./img/image-3.png" alt="Image"></picture>
        </li>
      </ul>
    </div>
  </section>
