...
?>
    <main>
      <section class="terms">
        <div class="container">
          <h1>Cookie Policy for topcas-review.com</h1>

          <p>This is the Cookie Policy for topcas-review.com, accessible from topcas-review.com</p>
          ...
          <ul>
            ...
            <li>
              <p>The Google AdSense service we use to serve advertising uses a DoubleClick cookie to serve more relevant
