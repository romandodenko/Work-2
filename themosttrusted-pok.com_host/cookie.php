...
?>
      <div class="page__bottom">
        <main>
          <section class="terms">
            <div class="container">
              <h1>Cookie Policy for themosttrusted-pok.com</h1>

              <p>This is the Cookie Policy for themosttrusted-pok.com, accessible from themosttrusted-pok.com</p>
              ...
              <ul>
                ...
                <li>
                  <p>From time to time we test new features and make subtle changes to the way that the site is
                    ...
                    our users appreciate the most.</p>
                </li>
