...
<head>
  ...
  <title>themosttrusted-pok.com</title>
</head>
              ...
              <ul class="nav__list">
                <li class="nav__item">
                  <a class="nav__link" href="main.php">
                    <img src="./img/header-icon-1.svg" alt="Icon">
                    Main page
                  </a>
                </li>
                <li class="nav__item">
                  <a class="nav__link" href="main.php#benefits">
                    <img src="./img/header-icon-2.svg" alt="Icon">
                    Advantages
                  </a>
                </li>
                <li class="nav__item">
                  <a class="nav__link" href="main.php#about">
                    <img src="./img/header-icon-3.svg" alt="Icon">
                    About us
                  </a>
                </li>
                <li class="nav__item">
                  <a class="nav__link" href="main.php#games">
                    <img src="./img/header-icon-4.svg" alt="Icon">
                    Games
                  </a>
                </li>
              </ul>
