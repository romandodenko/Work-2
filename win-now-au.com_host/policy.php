...
?>
      <div class="page__bottom">
        <main>
          ...
          <section class="terms">
            <div class="container">
              <h1>Privacy Policy for win-now-au.com</h1>

              <p>At win-now-au.com, accessible from win-now-au.com, one of our main priorities is the privacy of our
                visitors. This Privacy Policy document contains types of information that is collected and recorded by
                win-now-au.com and how we use it.</p>
              ...
              <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards to the information that they shared and/or collect in win-now-au.com. This policy is not
              ...
              <p>win-now-au.com follows a standard procedure of using log files. These files log visitors when they
              ...
              <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                are used in their respective advertisements and links that appear on win-now-au.com, which are sent
              ...
              <p>Note that win-now-au.com has no access to or control over these cookies that are used by third-party
                advertisers.</p>

              <h2>Third Party Privacy Policies</h2>

              <p>win-now-au.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
              ...
              <p>win-now-au.com does not knowingly collect any Personal Identifiable Information from children under the
