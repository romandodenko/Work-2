...
<head>
  ...
  <title>topsafeaus.com</title>
</head>

<body>
  <div class="page">
    <header class="popper">
      <div class="popper__container container">
        <a class="popper__logo" href="main.php">
        ...
        <div class="popper__menu">
          <a class="popper__logo popper__logo_menu" href="main.php">
            <img src="./img/logo.svg" alt="Logo">
          </a>
          <nav class="nav">
            <ul class="nav__list">
          ...
          <button class="popper__exit-menu"></button>
        </div>
      </div>
    </header>