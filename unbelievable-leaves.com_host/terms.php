    ...
    <main>
      <section class="terms">
        <div class="container">
          ...
          <p>Welcome to unbelievable-leaves.com!</p>

          <p>These terms and conditions outline the rules and regulations for the use of unbelievable-leaves.com's
            Website, located at unbelievable-leaves.com.</p>

          <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
            unbelievable-leaves.com if you do not agree to take all of the terms and conditions stated on this page.</p>
          ...
          <p>We employ the use of cookies. By accessing unbelievable-leaves.com, you agreed to use cookies in agreement
            with the unbelievable-leaves.com's Privacy Policy. </p>
          ...
          <p>Unless otherwise stated, unbelievable-leaves.com and/or its licensors own the intellectual property rights
            for all material on unbelievable-leaves.com. All intellectual property rights are reserved. You may access
            this from unbelievable-leaves.com for your own personal use subjected to restrictions set in these terms and
            conditions.</p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from unbelievable-leaves.com</li>
            <li>Sell, rent or sub-license material from unbelievable-leaves.com</li>
            <li>Reproduce, duplicate or copy material from unbelievable-leaves.com</li>
            <li>Redistribute content from unbelievable-leaves.com</li>
          </ul>

          <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
            certain
            areas of the website. unbelievable-leaves.com does not filter, edit, publish or review Comments prior to
            their
            presence on the website. Comments do not reflect the views and opinions of unbelievable-leaves.com,its
            agents
            and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions.
            To
            the extent permitted by applicable laws, unbelievable-leaves.com shall not be liable for the Comments or for
          ...
          <p>unbelievable-leaves.com reserves the right to monitor all Comments and to remove any Comments which can be
          ...
          <p>You hereby grant unbelievable-leaves.com a non-exclusive license to use, reproduce, edit and authorize
            others
          ...
          <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
            ...
            unbelievable-leaves.com; and (d) the link is in the context of general resource information.</p>
          ...
          <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
            website,
            you must inform us by sending an e-mail to unbelievable-leaves.com. Please include your name, your
          ...
          <p>No use of unbelievable-leaves.com's logo or other artwork will be allowed for linking absent a trademark
            license agreement.</p>
