...
?>
    <main>
      <section class="terms">
        <div class="container">
          <h1>Cookie Policy for themosttrusted-aus.com</h1>

          <p>This is the Cookie Policy for themosttrusted-aus.com, accessible from themosttrusted-aus.com</p>
          ...
          <ul>
            ...
            <li>
              <p>We use adverts to offset the costs of running this site and provide funding for further development.
                The behavioural advertising cookies used by this site are designed to ensure that we provide you with
                the most relevant adverts where possible by anonymously tracking your interests and presenting similar
