      ...
      <section class="terms">
        <div class="terms__container container">
          <div class="terms__column">
            <h1>Cookie Policy for goldfever-au.com</h1>

            <p>This is the Cookie Policy for goldfever-au.com, accessible from goldfever-au.com</p>
            ...
            <p>As is common practice with almost all professional websites this site uses cookies, which are tiny files
              ...
              can prevent these cookies from being stored however this may downgrade or 'break' certain elements of the
