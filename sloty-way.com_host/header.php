...
<head>
  ...
  <title>sloty-way.com</title>
</head>

<body>
  <div class="page">
    <header class="up">
      <div class="up__container container">
        <a class="up__logo" href="main.php">
        ...
        <div class="up__menu">
          <a class="up__logo up__logo_menu" href="main.php">
            <img src="./img/logo.svg" alt="Logo">
          </a>
          <nav class="nav">
            <ul class="nav__list">
          ...
          <button class="up__exit-menu"></button>
        </div>
      </div>
    </header>