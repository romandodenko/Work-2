          ...
          <div class="trapping__content">
            <div class="trapping__descr">
              ...
              <p class="trapping__text">
                Większość programistów udostępnia swoim grom tryb próbny, dzięki któremu użytkownicy mają możliwość
                wypróbowania gier za darmo. Tryb treningowy nie wymaga rejestracji i uzupełniania konta, ponieważ
                zakłady są dokonywane w kredytach warunkowych. Dlatego wersje demonstracyjne gier są przeznaczone dla
                graczy, którzy wolą wstępnie ocenić grę i zrozumieć zasady. Ta sama możliwość jest dostępna dla
                odwiedzających naszą stronę. Ta strona zawiera darmowe automaty do gry na komputerze lub smartfonie
        ...
        <div class="container">
          <ul class="elemet__list">
            ...
            <li class="elemet__item">
              ...
              <p class="elemet__text">
                Jeśli jesteś zmęczony przestarzałą grafiką i klasycznymi grami, nasza strona jest tym, czego
                potrzebujesz
              </p>
            </li>
            <li class="elemet__item">
